...
## 4. Visualization & Dashboarding (Business intelligence)
  ...
  - Created a Tableau dashboard to visualize Marketing ROI. Identified that "Barnacle" users (high loyalty, low spend) were draining resources, while "Butterfly" users (low loyalty, high spend) represented the biggest growth opportunity for utility payments.
